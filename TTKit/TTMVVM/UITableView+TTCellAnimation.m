...
@implementation TTTableCellAnimate
...
@implementation UITableView (TTCellAnimation)
- (void)TTTableCellAnimationWithType:(TTTableCellAnimationType)animationType
{
    [TTTableCellAnimate showWithAnimationType:animationType tableView:self];
}
