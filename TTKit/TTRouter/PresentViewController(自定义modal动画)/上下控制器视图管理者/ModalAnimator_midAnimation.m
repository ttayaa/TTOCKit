...
@implementation ModalAnimator_midAnimation
...
{
    PopPresentationController_AlphaBlack_frame * ppVc =[[PopPresentationController_AlphaBlack_frame alloc] initWithPresentedViewController:presented presentingViewController:presenting];
...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    else
    {
        ...
        [UIView animateWithDuration:0.1 animations:^{
            ...
            fromView.transform = CGAffineTransformMakeScale(0.0, 0.0001);
        } completion:^(BOOL finished) {
            // 一定要告诉系统转场动画结束
            // 不然会出现为止错误
            [transitionContext completeTransition:YES];
