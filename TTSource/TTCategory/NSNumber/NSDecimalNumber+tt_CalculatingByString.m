...
#import "NSDecimalNumber+tt_CalculatingByString.h"
...
@implementation NSDecimalNumber (tt_CalculatingByString)

+ (NSDecimalNumber *)tt_decimalNumberWithEquation:(NSString *)equation decimalNumbers:(NSDictionary *)numbers
{
