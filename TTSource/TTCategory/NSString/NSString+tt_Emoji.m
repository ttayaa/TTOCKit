...
#import "NSString+tt_Emoji.h"

@implementation NSString (tt_Emoji)

static NSDictionary * tt_s_unicodeToCheatCodes = nil;
static NSDictionary * tt_s_cheatCodesToUnicode = nil;

+ (void)tt_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        tt_s_unicodeToCheatCodes = forwardMap;
        tt_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)tt_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!tt_s_cheatCodesToUnicode) {
        [NSString tt_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [tt_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)tt_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [tt_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
