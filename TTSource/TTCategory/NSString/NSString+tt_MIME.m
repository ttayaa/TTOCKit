...
#import "NSString+tt_MIME.h"

@implementation NSString (tt_MIME)
/**
...
- (NSString *)tt_MIMEType {
    return [[self class] tt_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)tt_MIMETypeForExtension:(NSString *)extension {
    return [[self tt_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
