#import "TTChineseToPinyin.h"

NSString *tt_FindLetter(int nCode) {
	NSString *strValue = @"";
	switch(nCode) {
		case 6325:
		case 6436:
...
@implementation TTChineseToPinyin

+ (NSString *) tt_pinyinFromChiniseString:(NSString *)string {
    ...
    for (int i = 0; i < iLen; i++) {
		...
		NSString *strRes = tt_FindLetter(nCode);
...
+ (char) tt_sortSectionTitle:(NSString *)string {
	int cLetter = 0;
