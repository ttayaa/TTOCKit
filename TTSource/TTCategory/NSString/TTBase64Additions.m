...
#import "TTBase64Additions.h"

@implementation TTBase64Codec
...
+(NSData *)tt_dataFromBase64String:(NSString *)encoding
{
    NSData *data = nil;
...
@implementation NSString (tt_Base64Addition)
-(NSString *)tt_base64String
{
    NSData *utf8encoding = [self dataUsingEncoding:NSUTF8StringEncoding];
    return [TTBase64Codec tt_base64StringFromData:utf8encoding];
}
-(NSString *)tt_base64UrlEncodedString
{
    return [TTBase64Codec tt_base64UrlEncodedStringFromBase64String:[self tt_base64String]];
}
+(NSString *)tt_stringFromBase64String:(NSString *)base64String
{
    NSData *utf8encoding = [TTBase64Codec tt_dataFromBase64String:base64String];
...
{
    NSString *base64String=[TTBase64Codec tt_base64StringFromBase64UrlEncodedString:base64UrlEncodedString];
    //DLog(@"base64UrlEncodedString %@  base64String %@",base64UrlEncodedString,base64String);
    NSString *string=[self tt_stringFromBase64String:base64String];
...
@implementation NSData (tt_Base64Addition)
+(NSData *)tt_dataWithBase64String:(NSString *)base64String
{
    return [TTBase64Codec tt_dataFromBase64String:base64String];
}
+(NSData *)tt_dataWithBase64UrlEncodedString:(NSString *)base64UrlEncodedString
{
    return [self tt_dataWithBase64String:[TTBase64Codec tt_base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
-(NSString *)tt_base64String
{
    return [TTBase64Codec tt_base64StringFromData:self];
}
-(NSString *)tt_base64UrlEncodedString
{
    return [TTBase64Codec tt_base64UrlEncodedStringFromBase64String:[self tt_base64String]];
