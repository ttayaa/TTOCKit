...
typedef NS_ENUM(NSInteger, tt_LXMImagePosition) {
...
@interface UIButton (tt_LXMImagePosition)
 ...
 */
- (void)tt_setImagePosition:(tt_LXMImagePosition)postion spacing:(CGFloat)spacing;
