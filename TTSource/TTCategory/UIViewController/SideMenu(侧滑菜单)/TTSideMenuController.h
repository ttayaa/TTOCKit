//
//  TTSideMenuController.h
//  ttayaa
//

#import <UIKit/UIKit.h>

static NSString *const kTTSideMenuControllerWillShowLeftViewNotification    = @"kTTSideMenuControllerWillShowLeftViewNotification";
static NSString *const kTTSideMenuControllerWillDismissLeftViewNotification = @"kTTSideMenuControllerWillDismissLeftViewNotification";
static NSString *const kTTSideMenuControllerDidShowLeftViewNotification     = @"kTTSideMenuControllerDidShowLeftViewNotification";
static NSString *const kTTSideMenuControllerDidDismissLeftViewNotification  = @"kTTSideMenuControllerDidDismissLeftViewNotification";

static NSString *const kTTSideMenuControllerWillShowRightViewNotification    = @"kTTSideMenuControllerWillShowRightViewNotification";
static NSString *const kTTSideMenuControllerWillDismissRightViewNotification = @"kTTSideMenuControllerWillDismissRightViewNotification";
static NSString *const kTTSideMenuControllerDidShowRightViewNotification     = @"kTTSideMenuControllerDidShowRightViewNotification";
static NSString *const kTTSideMenuControllerDidDismissRightViewNotification  = @"kTTSideMenuControllerDidDismissRightViewNotification";

@interface TTSideMenuController : UIViewController
