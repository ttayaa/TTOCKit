...
//
//  TTSideMenuController.m
//  ttayaa
//

#import "TTSideMenuController.h"
...
@interface TTSideMenuController () <UIGestureRecognizerDelegate>
...
@implementation TTSideMenuController
               ...
               alwaysVisibleOptions:(MACSideMenuAlwaysVisibleOptions)alwaysVisibleOptions
{
    ...
    else NSLog(@"TTSideMenuController WARNING: Left view is already enabled");
}
                ...
                alwaysVisibleOptions:(MACSideMenuAlwaysVisibleOptions)alwaysVisibleOptions
{
    ...
    else NSLog(@"TTSideMenuController WARNING: Right view is already enabled");
}
...
- (void)showLeftViewPrepare
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerWillShowLeftViewNotification object:self userInfo:nil];
}
...
- (void)showLeftViewAnimated:(BOOL)animated fromPercentage:(CGFloat)percentage completionHandler:(void(^)())completionHandler
{
    if (animated)
    {
        [TTSideMenuController animateStandardWithDuration:0.5//*(1.f-percentage)
                                                animations:^(void)
         {
                                                ...
                                                completion:^(BOOL finished)
         {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerDidShowLeftViewNotification object:self userInfo:nil];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerWillDismissLeftViewNotification object:self userInfo:nil];
    
    if (animated)
    {
        [TTSideMenuController animateStandardWithDuration:0.5//*percentage
                                                animations:^(void)
         {
                                                ...
                                                completion:^(BOOL finished)
         {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerDidDismissLeftViewNotification object:self userInfo:nil];
...
- (void)showRightViewPrepare
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerWillShowRightViewNotification object:self userInfo:nil];
}
    ...
    if (animated)
    {
        [TTSideMenuController animateStandardWithDuration:0.5//*(1.f-percentage)
                                                ...
                                                completion:^(BOOL finished)
         {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerDidShowRightViewNotification object:self userInfo:nil];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerWillDismissRightViewNotification object:self userInfo:nil];
    ...
    if (animated)
    {
        [TTSideMenuController animateStandardWithDuration:0.5//*percentage
                                                ...
                                                completion:^(BOOL finished)
         {
             ...
             [[NSNotificationCenter defaultCenter] postNotificationName:kTTSideMenuControllerDidDismissRightViewNotification object:self userInfo:nil];
