...
@class TTIFlyFaceImage;

@protocol TTCaptureManagerDelegate <NSObject>

@optional


-(void)onOutputFaceImage:(TTIFlyFaceImage*)img;
-(void)observerContext:(CaptureContextType)type Changed:(BOOL)boolValue;

@end


@interface TTCaptureManager : NSObject

// delegate
@property (nonatomic) id<TTCaptureManagerDelegate> delegate;
