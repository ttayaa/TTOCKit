//
//  ModalAnimator_downMenuAnimation_clear.m
//  elmsc
//
...
@interface ModalAnimator_downMenuAnimation_clear ()
...
@implementation ModalAnimator_downMenuAnimation_clear
...
/**
 ...
 该框架中定义了一个PopPresentationController_AlphaBlack_frame继承自它
 (在这个类中我们主要用来处理目标控制器的view的frame)
 */
- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(UIViewController *)presenting sourceViewController:(UIViewController *)source NS_AVAILABLE_IOS(8_0)
{
    PopPresentationController_clearColor_frame * ppVc =[[PopPresentationController_clearColor_frame alloc] initWithPresentedViewController:presented presentingViewController:presenting];
    
    //传递目标控制器的View的尺寸
    //如果在这个方法中设置ppVc.presentedView.frame得到的结果不准确
    //所以需要再将frame传递给PopPresentationController_AlphaBlack_frame
