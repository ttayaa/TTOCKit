...
//        [self.currentVisibleController TTShowAlertMessage:@"请在设置->隐私->相机中，允许双师网访问" titile:@"照相机被禁用"];
        return;
    }
...
//        [self.currentVisibleController TTShowAlertMessage:@"请在设置->隐私->照片中，允许双师网访问" titile:@"照片被禁用"];
    }
}
